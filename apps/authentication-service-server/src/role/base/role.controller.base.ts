...
import { SystemUserFindManyArgs } from "../../systemUser/base/SystemUserFindManyArgs";
import { SystemUser } from "../../systemUser/base/SystemUser";
...
export class RoleControllerBase {
  ...
  async findSystemUsers(
    ...
    const query = plainToClass(SystemUserFindManyArgs, request.query);
    const results = await this.service.findSystemUsers(params.id, {
      ...query,
      select: {
        createdAt: true,
        email: true,
  ...
  @common.Post("/:id/systemUsers")
  @nestAccessControl.UseRoles({
    resource: "Role",
    action: "update",
    possession: "any",
  })
  async connectSystemUsers(
    @common.Param() params: RoleWhereUniqueInput,
    @common.Body() body: SystemUserWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      systemUsers: {
        connect: body,
  ...
  @common.Patch("/:id/systemUsers")
  @nestAccessControl.UseRoles({
    resource: "Role",
    action: "update",
    possession: "any",
  })
  async updateSystemUsers(
    @common.Param() params: RoleWhereUniqueInput,
    @common.Body() body: SystemUserWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/systemUsers")
  @nestAccessControl.UseRoles({
    resource: "Role",
    action: "update",
    possession: "any",
  })
  async disconnectSystemUsers(
    @common.Param() params: RoleWhereUniqueInput,
    @common.Body() body: SystemUserWhereUniqueInput[]
  ): Promise<void> {
    const data = {
